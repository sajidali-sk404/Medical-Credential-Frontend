...
import { Eye, EyeOff, Mail, Lock, Shield, CheckSquare, Square, Stethoscope } from "lucide-react";
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="mt-8">
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            <button onClick={LoadClientDemo} className="flex items-center justify-center gap-1.5 py-2 px-2 border border-gray-200 rounded-lg text-xs font-medium text-gray-700 hover:bg-gray-50 transition">
                                <div className="w-3.5 h-3.5 rounded-sm bg-gray-800 shrink-0" />
                                Client
                            </button>
                            <button onClick={LoadProviderDemo} className="flex items-center justify-center gap-1.5 py-2 px-2 border border-teal-200 bg-teal-50/50 rounded-lg text-xs font-medium text-teal-800 hover:bg-teal-100 transition">
                                <Stethoscope className="w-3.5 h-3.5 text-teal-600 shrink-0" />
                                Provider
                            </button>
                            <button onClick={LoadAdminDemo} className="flex items-center justify-center gap-1.5 py-2 px-2 border border-gray-200 rounded-lg text-xs font-medium text-gray-700 hover:bg-gray-50 transition">
                    ...
                    <div className="mt-8 text-center space-y-2">
                        ...
                        <p className="text-xs text-gray-400">
                            © 2026 CredFlow Clinical Network. All rights reserved.
                        </p>
                    </div>
                </div>
